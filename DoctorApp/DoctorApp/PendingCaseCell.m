...
@implementation PendingCaseCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.acceptBt = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 0, 0)];
        [self.acceptBt setBackgroundColor:[UIColor clearColor]];
        [self addSubview: self.acceptBt];
        
        self.declineBt = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 0, 0)];
        [self.declineBt setBackgroundColor:[UIColor clearColor]];
        [self addSubview: self.declineBt];
